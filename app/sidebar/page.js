...
const Sidebar = () => {
    ...
    return (
        <section className='flex flex-col w-1/5 bg-gray-900 min-h-screen font-body text-gray-300 p-2'>
            <div className='flex flex-col p-4 items-center gap-2'>
                <div className="w-28 h-28 rounded-full overflow-hidden border-2 border-cyan-400/50 shadow-md shadow-cyan-500/20">
                    <Image
                        src="/image/edited.me.jpg"
                        alt="Profile Image"
                        width={112}
                        height={112}
            ...
            <div className='flex flex-col flex-grow p-4 gap-6 text-sm font-semibold'>
                <Link href={'/'} className='flex flex-row items-center gap-4'>
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#D1D5DB" fill="none">
            ...
            <hr className='border-gray-800' />
            <div className='flex flex-row gap-3 mt-auto px-1 py-3 items-center justify-center'>
